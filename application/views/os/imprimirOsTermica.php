...
echo "<h5 style='font-size: 12px; text-align: right'>Valor Total: R$ " . number_format($totalProdutos + $totalServico, 2, ',', '.') . "  "."</h4>";
...
<!-- Fim Total OS -->
        ...
        <br>
        <table width="100%" style="font-size: 10px" class="table_xr">
            <thead>
                <tr>
                    <th>Termo de Uso</th>
                </tr>
        ...
        <br>
        <table width="100%" class="table_xr">
            <tr>
                <td><br>
                    <div style="font-size: 11px" align="center"><b>Assinatura do Tecnico</b></div>
                    <div style="font-size: 11px" align="center"><?php echo $result->nome ?></div><br>
                    <div align="center">-----------------------------------------</div><br>
                </td>
            </tr>
            <tr>
                <td>
                    <div style="font-size: 11px" align="center"><b>Assinatura do Cliente</b></div>
                    <div style="font-size: 11px" align="center"><?php echo $result->nomeCliente ?></div><br>
