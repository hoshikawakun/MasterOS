...
<a href="<?php echo base_url() ?>index.php/os/visualizar/<?php echo $result->idOs; ?>" title="Visualizar OS"
    class="btn btn-mini btn-secondary"><i class="fas fa-eye"></i> Visualizar OS</a>

<a target="_blank" title="Imprimir" class="btn btn-mini btn-inverse"
    href="<?php echo site_url() ?>/os/imprimir/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i> Imprimir
    A4</a>

<a target="_blank" title="Imprimir Termica" class="btn btn-mini btn-inverse"
    href="<?php echo site_url() ?>/os/imprimirTermica/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i>
    Imprimir Termica</a>

<a target="_blank" title="Imprimir Termica 2" class="btn btn-mini btn-inverse"
    href="<?php echo site_url() ?>/os/imprimirTermica2/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i>
    Imprimir Termica 2</a>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    echo 'selected'; } ?> value="Entregue - Faturado">Entregue - Faturado</option>
                                            ...
                                            <a href="https://www.linkcorreios.com.br/<?php echo $result->rastreio ?>"
                                                title="Rastrear" target="_new" class="btn btn-warning"><i
                                                    class="fas fa-envelope"></i> Rastrear</a>
                                            <button class="btn btn-primary" title="Atualizar" id="btnContinuar"><i
                                                    class="fas fa-sync-alt"></i> Atualizar</button>
                                        </div>

                                        <div class="span3">
                                            <label for="dataInicial">Data de Entrtada<span
                                                    class="required">*</span></label>
                                        ...
                                        <div class="span3">Nº Série
                                            ...
                                            <input id="dataSaida" autocomplete="off" class="span12 datepicker"
                                                type="text" name="dataSaida" value="<?php echo $result->dataSaida ?>" />
                                        </div>
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="garantia" type="text" class="span12 datepicker" name="garantia"
                                    ...
                                    <div class="span12" style="padding: 0px; margin-left: 0">
                                        <div align="center" style="padding: 3px">
                                            <?php if ($result->faturado == 0) { ?>
                                            <a href="#modal-faturar" title="Faturar" id="btn-faturar" role="button"
                                                data-toggle="modal" class="btn btn-danger"><i
                                                    class="fas fa-cash-register"></i> Faturar</a><?php } ?>

                                            <button class="btn btn-primary" title="Atualizar" id="btnContinuar"><i
                                                    class="fas fa-sync-alt"></i> Atualizar</button>

                                            <a href="<?php echo base_url() ?>index.php/os/visualizar/<?php echo $result->idOs; ?>"
                                                title="Visualizar OS" class="btn btn-secondary"><i
    ...
    echo '<a target="_blank" title="Adicionar OS" class="btn btn-success" href=' . base_url() . 'index.php/os/adicionar><i class="fas fa-plus"></i> Adicionar OS</a>';
                    ...
                    <div class="tab-pane" id="tab3">
                        <div class="span12 well" style="padding: 1%; margin-left: 0">
                            <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico"
                                ...
                                <div class="span2">
                                    <label for="">&nbsp;</label>
                                    <button class="btn btn-success span12"><i class="fas fa-plus"></i>
                                        Adicionar</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="tab-pane" id="tab4">
                    <div class="span12 well" style="padding: 1%; margin-left: 0" id="form-anexos">
                        <form id="formAnexos" enctype="multipart/form-data" action="javascript:;" accept-charset="utf-8"
                            s method="post">
                            <div class="span10">
                                <input type="hidden" name="idOsServico" id="idOsServico"
                                    value="<?php echo $result->idOs; ?>" />
                ...
                <div class="tab-pane" id="tab6">
                    <div class="span12 well" style="padding: 1%; margin-left: 0">
                        <div class="span12" style="padding: 1%; margin-left: 0">
                            <a href="#modal-equipamento" id="btn-equipamento" role="button" data-toggle="modal"
                                class="btn btn-success"><i class="fas fa-plus"></i> Adicionar Equipamento</a>
                        </div>
                    </div>
...
<div id="modal-anotacao" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="#" method="POST" id="formAnotacao">
        ...
        <div class="modal-footer">
            <button class="btn btn-warning" data-dismiss="modal" aria-hidden="true"
                id="btn-close-anotacao">Fechar</button>
...
<div id="modal-equipamento" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="#" method="POST" id="formEquipamento">
        ...
        <div class="modal-footer">
            <button class="btn btn-warning" data-dismiss="modal" aria-hidden="true"
                id="btn-close-equipamento">Fechar</button>
            <button class="btn btn-primary">Adicionar</button>
        </div>
    </form>
</div>
...
<!-- Modal Faturar-->
<div id="modal-faturar" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4">
                    ...
                    <input style="width: 4em;" id="num2" type="text" placeholder="%" onblur="calcular()" maxlength="3"
                        size="2" />
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
        ...
        <div class="modal-footer">
            <button class="btn btn-warning" data-dismiss="modal" aria-hidden="true"
                id="btn-cancelar-faturar">Cancelar</button>
            ...
            if (estoque < quantidade) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.result == true) {
                            $("#divProdutos").load(
                                "<?php echo current_url(); ?> #divProdutos");
                            $("#quantidade").val('');
                            $("#preco").val('');
                            $("#produto").val('').focus();
                        } else {
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.result == true) {
                        $("#divServicos").load(
                            "<?php echo current_url(); ?> #divServicos");
    ...
    $(document).on('click', 'a', function(event) {
        ...
        if ((idProduto % 1) == 0) {
            ...
            $.ajax({
                ...
                data: "idProduto=" + idProduto + "&quantidade=" + quantidade + "&produto=" +
                    produto + "&idOs=" + idOS,
                dataType: 'json',
                success: function(data) {
                    if (data.result == true) {
