            ...
            <div class="widget_box_Painel2">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="codDeBarra" maxlength="13" type="text" name="codDeBarra"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoqueMinimo" type="text" name="estoqueMinimo"
                                value="<?php echo $result->estoqueMinimo; ?>" />
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $.getJSON('<?php echo base_url() ?>assets/json/tabela_medidas.json', function(data) {
        for (i in data.medidas) {
            ...
            $("#unidade option[value=" + '<?php echo $result->unidade; ?>' + "]").prop("selected",
            true);
        }
    });
