...
<button type="submit" class="button_mini btn btn-success"><span class="button_icon"><i class='fas fa-plus-circle'></i></span><span class="button_text">Atualizar</span></button>
