...
<div id="modalCadastrar" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('mapos/cadastrarEmitente'); ?>" id="formCadastrar" enctype="multipart/form-data"
        ...
        <div class="modal-footer">
            <button class="btn btn-warning" data-dismiss="modal" aria-hidden="true"
                id="btnCancelExcluir">Cancelar</button>
            ...
            <div class="widget_box_Painel">
                ...
                <div class="widget_content">
                    <table width="100%" class="table_master_os">
                            ...
                            <tr>
                                <td style="width: 25%">
                                    <div align="center"><span><b>Logo</b></span> <img
                                            src=" <?= $dados[0]->url_logo; ?> " alt="Logo" /></div>
                                </td>
                                <td style="width: 25%">
                                    <div align="center"><span><b>Logo Térmica</b></span><img
                                            src=" <?= $dados[0]->url_termica; ?> " alt="Logo Térmica" /></div>
                                </td>
                                <td>
                        ...
                        <tr>
                            <td colspan="3">
                                <div align="center" style="padding: 10px;"><a href="#modalAlterar" data-toggle="modal"
                                        role="button" class="btn btn-primary">Atualizar Dados</a>
                                    <a href="#modalLogo" data-toggle="modal" role="button"
                                        class="btn btn-inverse">Atualizar Logo</a>
                                    <a href="#modalTermica" data-toggle="modal" role="button"
                                        class="btn btn-inverse">Atualizar Logo Termica</a>
                                </div>
                            </td>
                        </tr>
                    </table>
...
<div id="modalAlterar" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('mapos/editarEmitente'); ?>" id="formAlterar" enctype="multipart/form-data" method="post"
...
<div id="modalLogo" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('mapos/editarLogo'); ?>" id="formLogo" enctype="multipart/form-data" method="post"
        class="form-horizontal">
        <div class="modal_header_anexos">
            <button type="button" class="close" style="color:#f00" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="modalTermica" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('mapos/editarLogoTermica'); ?>" id="formLogoTermica" enctype="multipart/form-data"
        method="post" class="form-horizontal">
        <div class="modal_header_anexos">
            <button type="button" class="close" style="color:#f00" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="">Atualizar Logotipo</h3>
