            ...
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="nopadding tab-content">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline"><a
                                        href="whatsapp://send?phone=55<?= $configuration['masteros_1']?>"
                                        title="Enviar WhatsWapp" class="btn btn-success"><i class="fab fa-whatsapp"></i>
                                        Enviar WhatsWapp</a></span>
                                <span class="help-inline"><input disabled="disabled"
                                        value=" <?= $configuration['masteros_1']?>" readonly="readonly" /></span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="control_estoque" id="control_estoque">
                                    ...
                                    <option value="0"
                                        <?= $configuration['control_estoque'] == '0' ? 'selected' : ''; ?>>Não</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="control_baixa" id="control_baixa">
                                    <option value="1">Sim</option>
                                    <option value="0" <?= $configuration['control_baixa'] == '0' ? 'selected' : ''; ?>>
                                        Não</option>
                                </select>
                                <span class="help-inline">Ativar ou desativar o controle de baixa financeira, com data
                                    retroativa.</span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="control_editos" id="control_editos">
                                    <option value="1">Sim</option>
                                    <option value="0" <?= $configuration['control_editos'] == '0' ? 'selected' : ''; ?>>
                                        Não</option>
                                </select>
                                <span class="help-inline">Ativar ou desativar a permissão para alterar OS faturada e/ou
                                    cancelada.</span>
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <div id="menu6" class="tab-pane fade">
                        <div class="control-group">
                            <label class="help-inline">Defina a vizualização, onde o que ficar marcado será exibida na
                                listagem de OS por padrão.</label><br /><br />
                            <label class="span6"> <input
                                    <?= @in_array("Orçamento", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Orçamento"> <span
                                    class="lbl"> Orçamento</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Orçamento Concluido", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Orçamento Concluido">
                                <span class="lbl"> Orçamento Concluido</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Orçamento Aprovado", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Orçamento Aprovado">
                                <span class="lbl"> Orçamento Aprovado</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Em Andamento", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Em Andamento"> <span
                                    class="lbl"> Em Andamento</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Aguardando Peças", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Peças">
                                <span class="lbl"> Aguardando Peças</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Serviço Concluido", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Serviço Concluido">
                                <span class="lbl"> Serviço Concluido</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Sem Reparo", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Sem Reparo"> <span
                                    class="lbl"> Sem Reparo</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Não Autorizado", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Não Autorizado"> <span
                                    class="lbl"> Não Autorizado</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Contato sem Sucesso", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Contato sem Sucesso">
                                <span class="lbl"> Contato sem Sucesso</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Cancelado", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Cancelado"> <span
                                    class="lbl"> Cancelado</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Pronto-Despachar", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Pronto-Despachar">
                                <span class="lbl"> Pronto-Despachar</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Aguardando Envio", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Envio">
                                <span class="lbl"> Aguardando Envio</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Enviado", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Enviado"> <span
                                    class="lbl"> Enviado</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Aguardando Entrega Correio", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox"
                                    value="Aguardando Entrega Correio"> <span class="lbl"> Aguardando Entrega
                                    Correio</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Garantia", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Garantia"> <span
                                    class="lbl"> Garantia</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Abandonado", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Abandonado"> <span
                                    class="lbl"> Abandonado</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Comprado pela Loja", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                                    name="os_status_list[]" class="marcar" type="checkbox" value="Comprado pela Loja">
                                <span class="lbl"> Comprado pela Loja</span> </label>
                            <label class="span6"> <input
                                    <?= @in_array("Entregue - A Receber", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?>
                ...
                <!-- Modal -->
                <div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog"
                    ...
                    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <h7 style="text-align: left"><br>Faça o backup dos seguintes arquivos pois os mesmo serão
                                excluídos:</h7>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="update-mapos" type="button" class="btn btn-danger"><i
...
<!-- Modal -->
<div id="modal-confirmabanco" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <h7 style="text-align: left">Recomendamos que faça um backup antes de prosseguir!
                <a target="_blank" title="Fazer Bakup" class="btn btn-mini btn-inverse"
                    href="<?php echo site_url() ?>/mapos/backup">Fazer Backup</a>
            </h7>
        </div>
        <div class="modal-footer">
            <button class="btn btn-warning" data-dismiss="modal" aria-hidden="true">Cancelar</button>
            <button id="update-database" type="button" class="btn btn-warning"><i
                    class="fas fa-sync-alt"></i>Atualizar</button>
        </div>
    </form>
</div>
