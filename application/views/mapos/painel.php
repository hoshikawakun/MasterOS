...
<script language="javascript" type="text/javascript" src="<?= base_url(); ?>assets/js/dist/jquery.jqplot.min.js">
</script>
...
<div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <li class="bg_jj">
                <a href="<?= base_url() ?>index.php/produtos"> <i class="fas fa-shopping-bag"
            ...
            <li class="bg_jk">
                <a href="<?= base_url() ?>index.php/financeiro/lancamentos"><i class="fas fa-book"
                        style="font-size:36px"></i>
            ...
            <table class="table_p">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="center"><?= $o->nomeCliente ?></div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div align="center">
                                ...
                                <?php endif ?>
                                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?><a
                                    title="Imprimir Termica" class="btn btn-inverse tip-top"
                                    href="<?= base_url() ?>index.php/os/imprimirTermica/<?= $o->idOs ?>" class="btn"><i
                                        class="fas fa-print"></i></a>
                                <?php endif ?></div>
                        </td>
                    </tr>
                    ...
                    <?php else : ?>
                    <tr>
                        <td colspan="7">Nenhum Serviço Concluido.</td>
                    </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget_content">
            <table class="table_p">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                    <tr>
                        <td colspan="7">Nenhuma OS Aprovados.</td>
                    </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget_content">
            <table class="table_p">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                    <tr>
                        <td colspan="7">Nenhum Orçamento Concluido.</td>
                    </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget_content">
            <table class="table_p">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                    <tr>
                        <td colspan="7">Nenhuma OS Aguardando Peças.</td>
                    </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget_content">
            <table class="table_p">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                    <tr>
                        <td colspan="7">Nenhuma OS Entregue - A Receber.</td>
                    </tr>
                    <?php endif ?>
                </tbody>
            </table>
                        ...
                        <td>
                            <div align="center">
                                ...
                                <a title="Editar Produto"
                                    href="<?= base_url() ?>index.php/produtos/editar/<?= $p->idProdutos ?>" target="new"
                                    class="btn btn-info">
                                    <i class="fas fa-edit"></i></a>

                                <a title="Atualizar Estoque" href="#atualizar-estoque" role="button" data-toggle="modal"
                                    produto="<?= $p->idProdutos?>" estoque="<?=$p->estoque?>" class="btn btn-primary"><i
        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <form method="get">
                        <input type="number" name="year" style="height: 1.1rem; margin-bottom: 0; margin-top: 0.2rem"
                            value="<?php echo intval(preg_replace('/[^0-9]/', '', $this->input->get('year'))) ?: date('Y') ?>">
                        <button type="submit" class="btn-xs"
                            style="height: 1.8rem; margin-bottom: 0; margin-top: 0.2rem">Pesquisar</button>
                    </form>
                </div>
                <div class="widget_box_master_os">
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            <ul class="site-stats">
                                ...
                                <li class="bg_lh"><i class="fas fa-diagnoses"></i> <strong>
                                        <?= $this->db->count_all('os'); ?></strong> <small>Ordens de Serviço</small>
                                </li>
...
$(document).ready(function() {
    ...
    var plot2 = jQuery.jqplot('chart-financeiro', [data2], {
        ...
        seriesColors: ["#9ACD32", "#FF8C00", "#EAA228", "#579575", "#839557", "#958c12", "#953579",
            "#4b5de4", "#d8b83f", "#ff5800", "#0085cc"
        ],
        seriesDefaults: {
            // Make this a pie chart.
            renderer: jQuery.jqplot.PieRenderer,
    ...
    var plot3 = jQuery.jqplot('chart-financeiro2', [data3], {
            ...
            seriesColors: ["#90EE90", "#FF0000", "#EAA228", "#579575", "#839557", "#958c12", "#953579",
                "#4b5de4", "#d8b83f", "#ff5800", "#0085cc"
            ],
            seriesDefaults: {
                // Make this a pie chart.
...
<div id="calendarModal" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
...
<!-- Modal Excluir Os -->
<div id="modal-excluir-os" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
...
<!-- Modal Estoque -->
<div id="atualizar-estoque" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
