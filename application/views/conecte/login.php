...
<div id="particles-js"><canvas class="particles-js-canvas-el" width="842" height="913"
...
<body>
            ...
            <div class="control-group">
                <div class="controls">
                    <div class="main_input_box">
                        <span class="add-on bg_lg"><i class="fas fa-user"></i></span><input id="email" name="email"
                            type="text" placeholder="Email" value="<?php echo trim($parse_email); ?>" />
                    </div>
                </div>
            </div>
            <div class="control-group">
    ...
    <div id="notification" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog"
