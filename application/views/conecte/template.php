...
<body>
    ...
    <div class="navebarn" style="margin-top: -60px;height: 25px;margin-bottom: 15px">
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class='fas fa-user-cog iconN1'></i> <?= $this->session->userdata('nome') ?> </a>
    ...
    echo 'active';
}; ?>"><a href="<?php echo base_url() ?>index.php/mine/painel"><i class='fas fa-home iconX'></i> <span class="title">Painel</span></a></li>
                    <li class="<?php if (isset($menuConta)) {
    echo 'active';
}; ?>"><a href="<?php echo base_url() ?>index.php/mine/conta"><i class="fas fa-user-cog iconX"></i> <span class="title">Minha Contas</span></a></li>
                    <li class="<?php if (isset($menuOs)) {
    echo 'active';
}; ?>"><a href="<?php echo base_url() ?>index.php/mine/os"><i class='fas fa-diagnoses iconX'></i> <span class="title">Ordens de Serviço</span></a></li>
                    <li class="<?php if (isset($menuVendas)) {
    echo 'active';
}; ?>"><a href="<?php echo base_url() ?>index.php/mine/compras"><i class='fas fa-cash-register iconX'></i> <span class="title">Compras</span></a></li>
            ...
            <div style="margin-bottom: 40px" class="botton-content">
                <li class="">
                    <a href="<?= site_url('login/sair'); ?>">
                        <i class='fas fa-sign-out-alt iconX'></i>
