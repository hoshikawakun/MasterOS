  ...
  <div class="row-fluid" style="width: 100vw;height: 100vh;display: flex;align-items: center;justify-content: center">
    <div class="widget-box" style="align-items: center;padding: 0 15px;">
                ...
                <div class="widget-content nopadding tab-content">
                    <form action="<?php echo base_url() . 'index.php/conecte/tokenManual' ?>" id="formCliente" method="post" class="form-horizontal">
    ...
    <!--Footer-part-->
    <div class="row-fluid">
        <div id="footer" class="span12" style="padding: 10px"> <a class="pecolor" href="https://github.com/RamonSilva20/masteros" target="_blank">
