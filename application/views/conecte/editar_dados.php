...
<div class="row-fluid" style="margin-top:0">
    ...
    echo '<div class="alert alert-danger">' . $custom_error . '</div>';
                                ...
                                <label for="documento" class="control-label">CPF/CNPJ<span
                                        class="required">*</span></label>
                                <div class="controls">
                                    <input name="documento" type="text" class="cpfcnpj" id="documento"
                                        value="<?php echo $result->documento; ?>" readonly="readonly" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="celular" type="text" class="telefone1" name="celular"
                            ...
                            <div class="form_actions" align="center">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-sync-alt"></i>
                                    Atualizar</button>
                                <a href="<?php echo base_url() ?>index.php/mine/conta" id="" class="btn btn-warning"><i
