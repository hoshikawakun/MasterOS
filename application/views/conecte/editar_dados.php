...
<h5><i class="fas fa-user-cog"></i> Editar Meus Dados</h5>
</div>
...
<a title="Voltar" class="button_mini btn btn-warning" href="<?php echo base_url() ?>index.php/conecte/conta"><span class="button_icon"><i class="fas fa-undo-alt"></i></span> <span class="button_text">Voltar</span></a>
