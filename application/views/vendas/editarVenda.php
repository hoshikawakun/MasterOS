            ...
            <div class="widget_box_Painel2">
                ...
                <div class="form_actions" align="center">
                    ...
                    <a href="#modal-faturar" id="btn-faturar" role="button" data-toggle="modal"
                        class="btn btn-danger"><i class="fas fa-cash-register"></i> Faturar</a>
                    <?php
                                            } ?>
                    ...
                    <a href="<?php echo base_url() ?>index.php/vendas/visualizar/<?php echo $result->idVendas; ?>"
                        class="btn btn-inverse"><i class="fas fa-eye"></i> Visualizar Venda</a>
                    <a href="<?php echo base_url() ?>index.php/vendas" class="btn btn-warning"><i
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <input class="span12" id="descricao" type="text" name="descricao"
                    value="Fatura de Venda Nº: <?php echo $result->idVendas; ?> " />
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
