...
<div class="row-fluid" style="margin-top: 0">
    ...
    echo '<a title="Editar Venda" class="btn btn-mini btn-info" href="' . base_url() . 'index.php/vendas/editar/' . $result->idVendas . '"><i class="fas fa-edit"></i> Editar</a>';
                    ...
                    <a target="_blank" title="Imprimir" class="btn btn-mini btn-inverse"
                        href="<?php echo site_url() ?>/vendas/imprimir/<?php echo $result->idVendas; ?>"><i
                            class="fas fa-print"></i> Imprimir</a>
                    <a target="_blank" title="Imprimir" class="btn btn-mini btn-inverse"
                        href="<?php echo site_url() ?>/vendas/imprimirTermica/<?php echo $result->idVendas; ?>"><i
                    ...
                    <div class="invoice-head">
                        ...
                        <div class="invoice-content">
                            <table width="100%" class="table table-condensed">
                                ...
                                <?php } ?>
                                <tr>
                                    <td style="width: 25%"><br><img src=" <?php echo $emitente[0]->url_logo; ?> "
                                            style="max-height: 100px"></td>
                                    <td>
                                        <span
                                            style="font-size: 15px"><b><?php echo $emitente[0]->nome; ?></b></span></br>
                                        <span style="font-size: 13px"><i class="fas fa-fingerprint"
                                                style="margin:5px 1px"></i>
                                            <?php echo $emitente[0]->cnpj; ?></span></br>
                                        <span style="font-size: 13px"><i class="fas fa-map-marker-alt"
                                                style="margin:4px 3px"></i>
                                    ...
                                    <td style="width: 18%; text-align: center">
                                        ...
                                        <span>Data Venda:
                                            <?php echo date('d/m/Y', strtotime($result->dataVenda)); ?></span><br>
                            ...
                            <table width="100%" class="table table-condensend">
                                ...
                                <tr>
                                    <td style="width: 50%; padding-left: 0">
                                        ...
                                        <span style="font-size: 12px"><i class="fas fa-user-check"></i>
                                            <?php echo $result->nomeCliente ?></span><br>
                                        <span style="font-size: 12px"><i class="fas fa-fingerprint"
                                                style="margin:5px 1px"></i> <?php echo $result->documento ?></span><br>
                                        <span style="font-size: 12px"><i class="fas fa-map-marker-alt"
                                                style="margin:4px 3px"></i> <?php echo $result->rua ?>,
                                        ...
                                        <span style="font-size: 12px"><i class="fas fa-phone-alt"
                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        ...
                                        <span style="font-size: 12px"><i class="fas fa-phone-alt"
                                                style="margin:5px 1px"></i> <?php echo $result->telefone_usuario ?></span><br>
                                        <span style="font-size: 12px"><i class="fas fa-envelope"
                                                style="margin:5px 1px"></i> <?php echo $result->email_usuario ?></span>
                            ...
                            <table width="100%" style="font-size: 12px" class="table table-bordered table-condensed"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div align="center"><b>R$:
                                                <?php echo number_format($totalProdutos, 2, ',', '.'); ?></b></div>
                                    </td>
                                </tr>
                            </table>
                            <?php } ?>
        ...
        <a href="#modal-gerar-pagamento" id="btn-forma-pagamento" role="button" data-toggle="modal"
            class="btn btn-success"><i class="fas fa-cash-register"></i> Gerar Pagamento</a>
