...
<body>
    <div class="invoice-content">
        <table width="100%" class="table_r">
            ...
            <?php } else { ?>
            <tr>
                <td style="width: 25%"><br><img src=" <?php echo $emitente[0]->url_logo; ?> " style="max-height: 100px">
                </td>
                <td>
                ...
                <td style="text-align: center">
                    ...
                    <span style="font-size: 12px"><b>Data Venda:
                        </b><?php echo date('d/m/Y', strtotime($result->dataVenda)); ?></span></br>
        ...
        -->
            ...
            <tr>
                <td colspan="2">
                    ...
                    <span style="font-size: 12px"><i class="fas fa-fingerprint" style="margin:5px 1px"></i>
                        <?php echo $result->documento ?></span><br>
                    <span style="font-size: 12px"><i class="fas fa-map-marker-alt" style="margin:4px 3px"></i>
                        <?php echo $result->rua ?>,
                ...
                <td>
                    ...
                    <span style="font-size: 12px"><i class="fas fa-phone-alt" style="margin:5px 1px"></i>
                        <?php echo $result->telefone_usuario ?></span>
                </td>
            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div align="center"><strong>R$:
                                            <?php echo number_format($totalProdutos, 2, ',', '.'); ?></strong></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
