<div class="widget-box">
    ...
    <div class="widget_box_pr2">
        ...
        <div class="widget_content_permisao tab-content">
            <div class="accordion" id="collapse-group">
                <div class="accordion-group widget-box">
                    ...
                    <div class="collapse accordion-body" id="collapseGOne">
                        <div class="widget_content">
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vCliente" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vProduto" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vServico" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vOs" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vVenda" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vCobranca" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vGarantia" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
                            ...
                            <table width="100%" class="table_per">
                                <tbody>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vArquivo" class="marcar" type="checkbox" checked="checked"
                                                    value="1" />
