...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/tema.css" /><?php } ?>
    <?php if ($configuration['app_theme'] == 'novo') { ?>
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/tema2.css" /><?php } ?>
    <?php if ($configuration['app_theme'] == 'verde') { ?>
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/tema3.css" /><?php } ?>
...
<body>
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
            <li class=""><a title="" href="<?= site_url(); ?>/mine"><i class="fas fa-eye"></i> <span class="text">Área
                        do Cliente</span></a></li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class=""><a title="Meu Perfil" href="<?= site_url('mapos/minhaConta'); ?>"><i
                                class="fas fa-user"></i> <span class="text">Meu Perfil</span></a></li>
                    <li class="divider"></li>
                    <li class=""><a title="Sair do Sistema" href="<?= site_url('login/sair'); ?>"><i
                                class="fas fa-sign-out-alt"></i> <span class="text">Sair do Sistema</span></a></li>
                </ul>
            </li>
        </ul>
    </div>
