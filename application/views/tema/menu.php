...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="fas fa-list"></i> Menu</a>
    ...
    echo 'active';
}; ?>"><a href="<?= base_url() ?>"><i class="fas fa-home"></i> <span>Home</span></a></li>
    ...
    echo 'active';
        ...
        <li class="submenu <?php if (isset($menuRelatorios)) {
            ...
            <a href="#"><i class="fas fa-list-alt"></i> <span>Relatórios</span> <span class="counter_r"><i
                        class="fas fa-chevron-down"></i></span></a>
            <ul>
        ...
        <li class="submenu <?php if (isset($menuConfiguracoes)) {
            ...
            <a href="#"><i class="fas fa-cog"></i> <span>Configurações</span> <span class="counter_r"><i
                        class="fas fa-chevron-down"></i></span></a>
            <ul>
