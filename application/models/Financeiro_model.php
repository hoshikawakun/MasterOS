...
class Financeiro_model extends CI_Model
{
    ...
    public function getTotals($where = '')
    {
        $this->db->select("
            ...
            SUM(case when tipo = 'receita' then valor - desconto end) as receitas
        ");
    ...
    {
        $sql = "SELECT SUM(CASE WHEN baixado = 1 AND tipo = 'receita' THEN valor - desconto END) as total_receita,
